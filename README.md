...
You need to have installed Ultra Hand to use it.
...
1. Start MHGU
1. Press the key combo to open UltraHand Menu (L + Dpad Down + R joystick by default)
1. Open MHGU-Monster-Info with UltraHand
